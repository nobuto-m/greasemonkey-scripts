...
(function()
{
    ...
    var color_map = {
        'DistroRelease: [^ ]+ [^ ]+|SourcePackage: [^ ]+|LiveMediaBuild:|focal|eoan|disco|bionic|xenial': "yellow",  // things that might be helpful
        'regression': "red", // critical importance
        'cosmic|artful|zesty|yakkety|wily|vivid|utopic|trusty|saucy|raring|quantal|precise|oneiric|natty|maverick|lucid|karmic|jaunty|intrepid|hardy|gutsy|feisty|edgy|dapper|breezy|hoary|warty': "orange", // unsupported releases
