...
(function()
{
    ...
    var color_map = {
        'DistroRelease: [^ ]+ [^ ]+|SourcePackage: [^ ]+|LiveMediaBuild:|impish|hirsute|focal|bionic': "yellow",  // things that might be helpful
        'regression': "red", // critical importance
        'groovy|eoan|disco|cosmic|artful|zesty|yakkety|xenial|wily|vivid|utopic|trusty|saucy|raring|quantal|precise|oneiric|natty|maverick|lucid|karmic|jaunty|intrepid|hardy|gutsy|feisty|edgy|dapper|breezy|hoary|warty': "orange", // unsupported releases
